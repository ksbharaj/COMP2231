...
// This driver implements a stack using the Java API's java.util.LinkedList class
// to answer the requirements of Question 1
//******************************************************************************
...
public class Question1Driver 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("--- New LinkedListStack \"scientists\" created ---");
        System.out.println("---------  using LinkedListStack.java  ---------");
        LinkedListStack scientists = new LinkedListStack();
        System.out.println("\n");
