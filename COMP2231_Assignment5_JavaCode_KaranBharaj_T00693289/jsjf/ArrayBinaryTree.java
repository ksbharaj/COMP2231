...
// Implementation of ArrayBinaryTree.java now includes "operationCount" variable
// to help count the number of compartions and this compare the old heap sort to 
// the new "better" heap sort algorithm.
//******************************************************************************
...
public class ArrayBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
	...
	protected int modCount;
        ...
        // variable "opertaionCount" introduced
	...
	public ArrayBinaryTree() 
	{
            ...
            // "operationCount" initalised as zero
            operationCount = 0;
	}
